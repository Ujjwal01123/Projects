      ...
      <section class="pack pack-1">
        ...
        <div class="img-detail">
          <div class="detail">
            ...
            <div class="feature">
              <div class="features"><img src="icon/sun.png"><p>Highlights</p></div>
              <div class="features"><img src="icon/coffee.png"><p>Meals</p></div>
              <div class="features"><img src="icon/car.png"><p>Transfer</p></div>
              <div class="features"><img src="icon/home.png"><p>Hotel</p></div>
              <div class="features"><img src="icon/eye.png"><p>Sightseeing</p></div>
            </div>
          </div>
          <div class="price">
            <h1>₹${pkg.bestPrice}</h1>
